...
QSoundEffect* MainWindow::gameSound=nullptr;
    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(playBtn,&MyPushButton::clicked,[=](){
        ...
        QTimer::singleShot(300,this,[=](){
            ...
            playScene->show();
            //音效
            gameSound=new QSoundEffect(this);//QSoundEffect更流畅
            gameSound->setSource(QUrl("qrc:/res/GameSong.wav"));
            gameSound->setLoopCount(QSoundEffect::Infinite);
            gameSound->setVolume(0.8);
            gameSound->play();
        });
    });
